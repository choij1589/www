...
#files_stitched = ["DYm3000toInf", "DYm2000to3000", "DYm1500to2000", "DYm1000to1500", "DYm800to1000",
#				  "DYm700to800", "DYm500to700", "DYm400to500", "DYm200to400", "DYm100to200"]
...
#files_incl = ["DYm50_MG273_Incl", "DYm50_ext"]
files_incl = ["DYm50_MG273_Incl"]
files_stitched = ["DYm700toInf", "DYm400to700", "DYm200to400", "DYm100to200", "DYm50to100"]

xsecs = {
	"DYm50_MG273_Incl": 6.399e+03,
	#"DYm50_ext": 6.545e+03,
	"DYm50to100": 6.287e+03,
	"DYm100to200": 2.482e+02,
	"DYm200to400": 8.566e+00,
	"DYm400to700": 7.106e-01,
	"DYm700toInf": 9.643e-02
}
...
lumi = 150.  # fb^-1
selector_arg = "_lhe"
output_path = "Outputs/DrellYan/MassBinned"

# get histograms
root_files = {}
dir_samples = "Samples/MassBinned"
store_name = "DYInclVsMassBinned"
